...
int syscall_env_var(u_int envid, int op, const char *name, const char *value);
...
int fsipc_remove(const char *, int, int, int);
int fsipc_sync(void);
int fsipc_incref(u_int);
int fsipc_copy(const char*, const char*, int);
int fsipc_move(const char*, const char*, int);
...
//extern struct Environment part[100];
//extern int partnum;
#endif
